...
import pytest
import os
from theoops.rules.fix_file import match, get_new_command
...
('node oops.js asdf qwer', '/Users/pablo/Workspace/barebones/oops.js', '2', 5, '',
"""
/Users/pablo/Workspace/barebones/oops.js:2
conole.log(arg);  // this should read console.log(arg);
^
ReferenceError: conole is not defined
    at /Users/pablo/Workspace/barebones/oops.js:2:5
    at Array.forEach (native)
    at Object.<anonymous> (/Users/pablo/Workspace/barebones/oops.js:1:85)
...
('py.test', '/home/theoops/tests/rules/test_fix_file.py', 218, None,
"""
...
/home/theoops/tests/rules/test_fix_file.py:218: NameError
""", ''),
)
