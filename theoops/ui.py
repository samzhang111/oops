...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[theoops.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype heoops.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[theoops.types.CorrectedCommand]
    :rtype: theoops.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No oopss given')
        return
